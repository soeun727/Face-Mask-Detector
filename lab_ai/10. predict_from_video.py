...
face_mask_recognition_model = cv2.dnn.readNet(
    'D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models/face_mask_recognition.prototxt',
    'D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models/face_mask_recognition.caffemodel'
)

mask_detector_model = tf.keras.models.load_model('D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models/mymodel')

cap = cv2.VideoCapture('D:/문서/GitHub/Face-Mask-Detector/Mask-Training/data/04.mp4')
