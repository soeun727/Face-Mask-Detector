...
history = model.fit(rc_train_dataset, epochs=2, validation_data=rc_valid_dataset)    # 에포크: 훈련을 몇번할 것인가
print(history)

# 모델 저장
# 경로 지정
if not os.path.exists('D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models'):
    os.mkdir('D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models')

# 모델을 저장하는 코드
model.save('D:/문서/GitHub/Face-Mask-Detector/Mask-Training/models/mymodel')